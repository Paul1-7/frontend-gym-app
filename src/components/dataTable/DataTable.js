...
const DataTable = ({
  ...
  dataFiltered = filterCheck && filterCheckValue ? filterCheck(dataFiltered) : dataFiltered;
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    onChange={() => setFilterCheckValue(!filterCheckValue)}
                  />
                }
                label={labelFilterCheck ?? ''}
              />
            </FormGroup>
          </Grid>
        )}
...
DataTable.propTypes = {
  ...
  filterCheck: PropTypes.func,
  labelFilterCheck: PropTypes.string,
};
